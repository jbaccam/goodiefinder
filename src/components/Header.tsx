      ...
      >
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <motion.div
            ...
            className="bg-lavender p-2.5 sm:p-3 rounded-2xl shadow-soft"
          >
            <Cat className="w-7 h-7 sm:w-8 sm:h-8 text-cream" />
          </motion.div>
        ...
        <motion.p
          ...
          className="text-text-secondary text-base sm:text-lg flex items-center gap-2"
        >
